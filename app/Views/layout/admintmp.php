...
<head>
    ...
    <title>UMKM Tanjung - <?= $judul ?></title>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <?php if (!$user['img']) : ?>
                                    <img src="assets/img/default/default.png" alt="" class="img-profile rounded-circle">
                                <?php else : ?>
                                    <img src="assets/img/fotoProfile/<?= $user['img'] ?>" alt="" class="img-profile rounded-circle">
                                <?php endif; ?>
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; UMKM TANJUNG SIDOARJO 2020</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Pilih "Keluar" dibawah jika ingin mengakhiri sesi.</div>
